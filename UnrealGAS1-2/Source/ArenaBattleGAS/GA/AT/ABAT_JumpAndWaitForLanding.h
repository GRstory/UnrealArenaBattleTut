...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Ability/Tasks", meta = (DisplayName = "JumpAndWaitForLanding", HidePin = "OwningAbility", HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE"))
